<!-- chunk_id: ASDEmbeddedNodeElement_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/model/elements/ASDEmbeddedNodeElement.html",
 "title": "3.1.10.31. ASDEmbeddedNode Element",
 "category": "command_manual",
 "manual_group": "model",
 "command": "ASDEmbeddedNodeElement",
 "doc_section": "user/manual/model/elements",
 "rel_path": "user/manual/model/elements/ASDEmbeddedNodeElement.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 7711,
 "word_count": 1231,
...
## 3.1.10.31. ASDEmbeddedNode Element
...
Fig. 3.1.10.36 Embedding geometry defined by the retained nodes. (Left) triangle for 2D continuum problems or 3D shell problems. (Right) tetrahedron for 3D continuum problems.
