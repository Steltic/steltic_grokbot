<!-- chunk_id: APDMD_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/material/uniaxialMaterials/APDMD.html",
 "title": "APDMD Material",
 "category": "command_manual",
 "manual_group": "material",
 "command": "APDMD",
 "doc_section": "user/manual/material/uniaxialMaterials",
 "rel_path": "user/manual/material/uniaxialMaterials/APDMD.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 4298,
 "word_count": 679,
...
**uniaxialMaterial APDMD $matTag $fy1 $E1 $ad2 $fy2 $E2 $b1 $b2 $a1 $n1 $a2 $n2**
