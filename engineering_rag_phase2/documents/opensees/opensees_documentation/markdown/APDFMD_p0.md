<!-- chunk_id: APDFMD_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/material/uniaxialMaterials/APDFMD.html",
 "title": "APDFMD Material",
 "category": "command_manual",
 "manual_group": "material",
 "command": "APDFMD",
 "doc_section": "user/manual/material/uniaxialMaterials",
 "rel_path": "user/manual/material/uniaxialMaterials/APDFMD.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 2309,
 "word_count": 355,
...
**uniaxialMaterial APDFMD $matTag $fy1 $E1 $ad2 $fy2 $E2 $a2 $n2**
