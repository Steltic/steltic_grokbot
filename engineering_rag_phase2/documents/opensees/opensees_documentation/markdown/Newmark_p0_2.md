<!-- chunk_id: Newmark_p0_2 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/analysis/integrator/Newmark.html",
 "title": "3.2.6.6. Newmark Method",
 "category": "command_manual",
 "manual_group": "analysis",
 "command": "Newmark",
 "doc_section": "user/manual/analysis/integrator",
 "rel_path": "user/manual/analysis/integrator/Newmark.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 4388,
 "word_count": 629,
