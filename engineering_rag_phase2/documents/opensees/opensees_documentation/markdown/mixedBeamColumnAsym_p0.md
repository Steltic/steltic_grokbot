<!-- chunk_id: mixedBeamColumnAsym_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/model/elements/mixedBeamColumnAsym.html",
 "title": "3.1.10.12. Mixed Beam Element (Asymmetric Sections)",
 "category": "command_manual",
 "manual_group": "model",
 "command": "mixedBeamColumnAsym",
 "doc_section": "user/manual/model/elements",
 "rel_path": "user/manual/model/elements/mixedBeamColumnAsym.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 12192,
 "word_count": 1535,
...
## 3.1.10.12. Mixed Beam Element (Asymmetric Sections)
...
**element mixedBeamColumnAsym $eleTag $iNode $jNode $numIntgrPts $secTag $transfTag <-shearCenter $y0 $z0> <-integration integrType>**
...
Fig. 3.1.10.13 Fig. 1: Coordinate systems for members with asymmetric sections (CC’: centroidal axis, SS’: shear center axis)

**PYTHON ELEMENT COMMAND**

For 3D problems:

**element(*'mixedBeamColumnAsym'*, *$eleTag*, *$iNode*, *$jNode*, *$transfTag*, *$integrTag*, *'-shearCenter'*, *$y0*, *$z0*)**
...
1. Du, X., & Hajjar, J. F. (2021). Three-dimensional nonlinear mixed 6-DOF beam element for thin-walled members. Thin-Walled Structures, 164, 107817.
