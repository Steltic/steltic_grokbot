<!-- chunk_id: pathTimeSeries_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/model/pathTimeSeries.html",
 "title": "3.1.6.7. Path TimeSeries",
 "category": "command_manual",
 "manual_group": "model",
 "command": "pathTimeSeries",
 "doc_section": "user/manual/model",
 "rel_path": "user/manual/model/pathTimeSeries.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 1415,
 "word_count": 220,
