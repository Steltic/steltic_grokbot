<!-- chunk_id: EnvelopeNodeRecorder_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/output/EnvelopeNodeRecorder.html",
 "title": "3.3.1.2. Envelope Node Recorder",
 "category": "command_manual",
 "manual_group": "output",
 "command": "EnvelopeNodeRecorder",
 "doc_section": "user/manual/output",
 "rel_path": "user/manual/output/EnvelopeNodeRecorder.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 4277,
 "word_count": 727,
...
## 3.3.1.2. Envelope Node Recorder
...
**recorder(*EnvelopeNode*, *<-file $filename>*, *<-xml $filename>*, *<-binary $filename>*, *<-tcp $inetAddress $port>*, *<-precision $nSD>*, *<-timeSeries $tsTag>*, *<-time>*, *<-dT $deltaT>*, *<-closeOnWrite>*, *<-node $nodeTags>*, *< -nodeRange $startNode $endNode>*, *<-region $regionTag> -dof $dofs $respType*)**
...
1. $deltaT, time interval for recording. will record when next step is $deltaT greater than last recorder step. Not really useful for Envelope recorder, a legacy from NodeRecorder!
