<!-- chunk_id: TzSimple1_p0_2 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/model/uniaxialMaterials/TzSimple1.html",
 "title": "3.4.1.4. TzSimple1 Material",
 "category": "command_manual",
 "manual_group": "model",
 "command": "TzSimple1",
 "doc_section": "user/manual/model/uniaxialMaterials",
 "rel_path": "user/manual/model/uniaxialMaterials/TzSimple1.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 4776,
 "word_count": 748,
