<!-- chunk_id: ProfileSPD_p0_2 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/analysis/ProfileSPD.html",
 "title": "3.2.3.3. ProfileSPD System",
 "category": "command_manual",
 "manual_group": "analysis",
 "command": "ProfileSPD",
 "doc_section": "user/manual/analysis",
 "rel_path": "user/manual/analysis/ProfileSPD.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 1779,
 "word_count": 298,
