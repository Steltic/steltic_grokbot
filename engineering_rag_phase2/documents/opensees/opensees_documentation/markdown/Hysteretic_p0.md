<!-- chunk_id: Hysteretic_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/material/uniaxialMaterials/Hysteretic.html",
 "title": "3.1.5.16. Hysteretic Material",
 "category": "command_manual",
 "manual_group": "material",
 "command": "Hysteretic",
 "doc_section": "user/manual/material/uniaxialMaterials",
 "rel_path": "user/manual/material/uniaxialMaterials/Hysteretic.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 1798,
 "word_count": 311,
