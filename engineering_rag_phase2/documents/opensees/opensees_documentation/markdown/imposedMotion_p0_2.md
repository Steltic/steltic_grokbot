<!-- chunk_id: imposedMotion_p0_2 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/model/pattern/groundmotion/imposedMotion.html",
 "title": "3.1.12.3.2. Imposed Motion Command",
 "category": "command_manual",
 "manual_group": "model",
 "command": "imposedMotion",
 "doc_section": "user/manual/model/pattern/groundmotion",
 "rel_path": "user/manual/model/pattern/groundmotion/imposedMotion.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 1404,
 "word_count": 198,
...
## 3.1.12.3.2. Imposed Motion Command
