<!-- chunk_id: HystereticSM_materialDemo_p0_2 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/material/uniaxialMaterials/examples/HystereticSM_materialDemo.html",
 "title": "Opensees uniaxialMaterial Demo: HystereticSM",
 "category": "command_manual",
 "manual_group": "material",
 "command": "HystereticSM_materialDemo",
 "doc_section": "user/manual/material/uniaxialMaterials/examples",
 "rel_path": "user/manual/material/uniaxialMaterials/examples/HystereticSM_materialDemo.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 4959,
 "word_count": 350,
