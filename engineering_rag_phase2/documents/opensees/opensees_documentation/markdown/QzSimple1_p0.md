<!-- chunk_id: QzSimple1_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/model/uniaxialMaterials/QzSimple1.html",
 "title": "3.4.1.5. QzSimple1 Material",
 "category": "command_manual",
 "manual_group": "model",
 "command": "QzSimple1",
 "doc_section": "user/manual/model/uniaxialMaterials",
 "rel_path": "user/manual/model/uniaxialMaterials/QzSimple1.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 6399,
 "word_count": 999,
