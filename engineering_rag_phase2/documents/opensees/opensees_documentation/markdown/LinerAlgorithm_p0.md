<!-- chunk_id: LinerAlgorithm_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/analysis/LinerAlgorithm.html",
 "title": "Linear Algorithm",
 "category": "command_manual",
 "manual_group": "analysis",
 "command": "LinerAlgorithm",
 "doc_section": "user/manual/analysis",
 "rel_path": "user/manual/analysis/LinerAlgorithm.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 1197,
 "word_count": 184,
