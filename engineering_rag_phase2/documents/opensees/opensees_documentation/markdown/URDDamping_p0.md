<!-- chunk_id: URDDamping_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/model/damping/elementalDamping/URDDamping.html",
 "title": "3.1.13.3.2. Universal Rate-Dependent (URD) Damping",
 "category": "command_manual",
 "manual_group": "model",
 "command": "URDDamping",
 "doc_section": "user/manual/model/damping/elementalDamping",
 "rel_path": "user/manual/model/damping/elementalDamping/URDDamping.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 5912,
 "word_count": 912,
...
**Approach 1**  Only the target loss factor distribution is used. The command will calculate the best approximation using the least-squares approach. More details are provided in [reference [1]](http://dx.doi.org/10.1016/j.engstruct.2022.113894).
...
According to [reference [1]](http://dx.doi.org/10.1016/j.engstruct.2022.113894) , the following commands are equivalent.
...
**Approach 2**  Optimal parameters for URD damping are used. These parameters may be obtained using Matlab and other software to achieve the best approximation. More details are provided in [reference [1]](http://dx.doi.org/10.1016/j.engstruct.2022.113894).
...
**Code Developed by**: [Yuan Tian](https://ytian.pro) (University of Science and Technology Beijing), Yuli Huang and [Xinzheng Lu](http://www.luxinzheng.net/english.htm) (Tsinghua University).

**References**

**1**

> Tian Y, Fei Y, Huang Y, Lu X. 2022. [A universal rate-dependent damping model for arbitrary damping-frequency distribution](https://www.researchgate.net/publication/358212097_A_universal_rate-dependent_damping_model_for_arbitrary_damping-frequency_distribution). Engineering Structures, 255: 113894. [http://dx.doi.org/10.1016/j.engstruct.2022.113894](http://dx.doi.org/10.1016/j.engstruct.2022.113894) (Available examples at: [http://pan.ustb.edu.cn/l/NHfFBB](http://pan.ustb.edu.cn/l/NHfFBB) )
