<!-- chunk_id: Umfpack_p0_2 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/analysis/system/Umfpack.html",
 "title": "3.2.3.5. Umfpack System",
 "category": "command_manual",
 "manual_group": "analysis",
 "command": "Umfpack",
 "doc_section": "user/manual/analysis/system",
 "rel_path": "user/manual/analysis/system/Umfpack.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 1458,
 "word_count": 218,
