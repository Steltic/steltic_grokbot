<!-- chunk_id: linearTimeSeries_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/model/linearTimeSeries.html",
 "title": "3.1.6.2. Linear TimeSeries",
 "category": "command_manual",
 "manual_group": "model",
 "command": "linearTimeSeries",
 "doc_section": "user/manual/model",
 "rel_path": "user/manual/model/linearTimeSeries.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 830,
 "word_count": 136,
...
Fig. 3.1.6.2 Linear Time Series
