<!-- chunk_id: thermalexample2_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/examples/thermalExamples/thermalexample2.html",
 "title": "4.2.2. Example 2",
 "category": "examples",
 "manual_group": "",
 "command": "thermalexample2",
 "doc_section": "user/examples/thermalExamples",
 "rel_path": "user/examples/thermalExamples/thermalexample2.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 8581,
 "word_count": 1241,
...
#### 4.2.2.1. Restrained Steel beam subjected to uniform temperature on half of the member.
...
[`Example2.tcl`](https://OpenSees.github.io/OpenSeesDocumentation/_downloads/876dcef979a5c2e6998b2306cef4c80b/Example2.tcl).

[`Example 2 Outputs`](https://OpenSees.github.io/OpenSeesDocumentation/_downloads/ab21db9bc6e52cb3c53e191333a67c1a/EXAMPLE2_OUTPUT.zip).
...
Element 1 will remain at ambient temperature 20 o C, while Element 2
will be heated to the target tempurature. The syntax for this is:

**pattern Plain 1 Linear {eleLoad -ele 1 -type –beamThermal $T $Y2 $T Y1; eleLoad -ele 2 -type –beamThermal $T $Y2 $T Y1 }**

##### 4.2.2.1.8. Thermal Analysis
...
was linearly ramped up from ambient to 1180 o C, the user can develop a
