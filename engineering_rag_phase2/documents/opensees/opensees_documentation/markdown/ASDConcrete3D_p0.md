<!-- chunk_id: ASDConcrete3D_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/material/ndMaterials/ASDConcrete3D.html",
 "title": "3.1.6.18. ASDConcrete3D Material",
 "category": "command_manual",
 "manual_group": "material",
 "command": "ASDConcrete3D",
 "doc_section": "user/manual/material/ndMaterials",
 "rel_path": "user/manual/material/ndMaterials/ASDConcrete3D.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 14755,
 "word_count": 1922,
...
| -implexAlpha $alpha | *string* + *float* | Optional. Default = 1. The \(\alpha\) coefficient for the explicit extrapolation of the internal variables in the IMPL-EX algorithm. It can range from 0 to 1. |
...
| -eta $eta | *string* + *float* | Optional. If defined, the rate-dependent model is used (By default the model is rate-independent). **-eta**: Activates the rate-dependent model. **eta**: The viscosity parameter \(\eta\), representing the relaxation time of the viscoplastic system. |
...
| -Kc $Kc | *string* + *float* | Optional. **-Kc**: A keyword that precedes the float. **$Kc**: A coefficient that defines the shape of the failure surface in triaxial compression. It must be \(1/2 < K_c <= 1\), default = \(2/3\). The lower \(K_c\), the stronger is the material in triaxial compression: Fig. 3.1.6.2 Effect of \(K_c\) on the triaxial-compression part of the failure surface. |
...
A Python example to draw the damage surface in the plane-stress case: [`ASDConcrete3D_Ex_Surface.py`](https://OpenSees.github.io/OpenSeesDocumentation/_downloads/5a70755c52099f50fed9bf3cec031801/ASDConcrete3D_Ex_Surface.py)

Example 2 - Understanding the Hardening/Softening Laws

A Python module to generate typical hardening-softening laws for normal concrete: [`ASDConcrete3D_MakeLaws.py`](https://OpenSees.github.io/OpenSeesDocumentation/_downloads/da5ea4c2de6eae800594bdb2af3629d0/ASDConcrete3D_MakeLaws.py)

Simple example to test it under uniaxial conditions in tension and compression: [`ASDConcrete3D_Ex_CyclicUniaxialTension.py`](https://OpenSees.github.io/OpenSeesDocumentation/_downloads/b404e91561ad07c70e6d1010ea9906b0/ASDConcrete3D_Ex_CyclicUniaxialCompression.py) and [`ASDConcrete3D_Ex_CyclicUniaxialCompression.py`](https://OpenSees.github.io/OpenSeesDocumentation/_downloads/b404e91561ad07c70e6d1010ea9906b0/ASDConcrete3D_Ex_CyclicUniaxialCompression.py)

#### 3.1.6.18.3. References

**Petracca2022**

> Petracca, M., Camata, G., Spacone, E., & Pelà, L. (2022). “Efficient Constitutive Model for Continuous Micro-Modeling of Masonry Structures” International Journal of Architectural Heritage, 1-13 ([Link to article](https://www.researchgate.net/profile/Luca-Pela/publication/363656245_Efficient_Constitutive_Model_for_Continuous_Micro-Modeling_of_Masonry_Structures/links/6332e7f1165ca22787785134/Efficient-Constitutive-Model-for-Continuous-Micro-Modeling-of-Masonry-Structures.pdf))

**Oliver2008**

> Oliver, J., Huespe, A. E., & Cante, J. C. (2008). “An implicit/explicit integration scheme to increase computability of non-linear material and contact/friction problems” Computer Methods in Applied Mechanics and Engineering, 197(21-24), 1865-1889 ([Link to article](https://core.ac.uk/download/pdf/325948712.pdf))
