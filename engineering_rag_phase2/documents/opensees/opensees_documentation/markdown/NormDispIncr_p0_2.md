<!-- chunk_id: NormDispIncr_p0_2 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/analysis/NormDispIncr.html",
 "title": "3.2.4.2. Norm Displacement Increment",
 "category": "command_manual",
 "manual_group": "analysis",
 "command": "NormDispIncr",
 "doc_section": "user/manual/analysis",
 "rel_path": "user/manual/analysis/NormDispIncr.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 1920,
 "word_count": 327,
