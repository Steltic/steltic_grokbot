<!-- chunk_id: groundMotion_p0_2 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/model/pattern/groundmotion/groundMotion.html",
 "title": "3.1.12.3.1. Ground Motion",
 "category": "command_manual",
 "manual_group": "model",
 "command": "groundMotion",
 "doc_section": "user/manual/model/pattern/groundmotion",
 "rel_path": "user/manual/model/pattern/groundmotion/groundMotion.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 3262,
 "word_count": 489,
