<!-- chunk_id: PySimple1_p0_2 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/material/uniaxialMaterials/PySimple1.html",
 "title": "3.1.5.32. PySimple1 Material",
 "category": "command_manual",
 "manual_group": "material",
 "command": "PySimple1",
 "doc_section": "user/manual/material/uniaxialMaterials",
 "rel_path": "user/manual/material/uniaxialMaterials/PySimple1.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 7217,
 "word_count": 1075,
...
In general the [Hilber-Hughes-Taylor Method](https://OpenSees.github.io/OpenSeesDocumentation/user/manual/analysis/integrator/HHT.html#hilberhughestaylormethod) algorithm is preferred over a [Newmark Method](https://OpenSees.github.io/OpenSeesDocumentation/user/manual/analysis/integrator/Newmark.html#newmark) algorithm when using this material. This is due to the numerical oscillations that can develop with viscous damping forces under transient loading with certain solution algorithms and damping ratios.

The equations describing PySimple1 behavior are described in [[BoulangerEtAl1999]](https://OpenSees.github.io/OpenSeesDocumentation/user/manual/material/uniaxialMaterials/TzSimple1.html#boulangeretal1999). Only minor changes have been made in its implementation for OpenSees.
