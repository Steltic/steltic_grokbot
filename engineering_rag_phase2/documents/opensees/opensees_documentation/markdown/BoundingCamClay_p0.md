<!-- chunk_id: BoundingCamClay_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/material/ndMaterials/BoundingCamClay.html",
 "title": "3.1.6.6. Bounding Cam Clay",
 "category": "command_manual",
 "manual_group": "material",
 "command": "BoundingCamClay",
 "doc_section": "user/manual/material/ndMaterials",
 "rel_path": "user/manual/material/ndMaterials/BoundingCamClay.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 4572,
 "word_count": 704,
...
## 3.1.6.6. Bounding Cam Clay

Code Developed by: [Chris McGann](https://www.canterbury.ac.nz/engineering/contact-us/people/chris-mcgann.html) and [Pedro Arduino](https://www.ce.washington.edu/facultyfinder/pedro-arduino) U.Washington

This command is used to construct a multi-dimensional bounding surface Cam Clay material object after Borja et al. ([Borja2001]).
