<!-- chunk_id: fix_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/model/sp_constraint/fix.html",
 "title": "3.1.3.1. fix Command",
 "category": "command_manual",
 "manual_group": "model",
 "command": "fix",
 "doc_section": "user/manual/model/sp_constraint",
 "rel_path": "user/manual/model/sp_constraint/fix.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 892,
 "word_count": 162,
