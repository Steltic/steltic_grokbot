<!-- chunk_id: LoadControl_p0_2 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/analysis/LoadControl.html",
 "title": "3.2.6.1. LoadControl Command",
 "category": "command_manual",
 "manual_group": "analysis",
 "command": "LoadControl",
 "doc_section": "user/manual/analysis",
 "rel_path": "user/manual/analysis/LoadControl.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 2104,
 "word_count": 347,
