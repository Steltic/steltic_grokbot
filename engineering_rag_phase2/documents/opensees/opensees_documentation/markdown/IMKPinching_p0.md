<!-- chunk_id: IMKPinching_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/material/uniaxialMaterials/IMKPinching.html",
 "title": "3.1.5.20. IMKPinching Material",
 "category": "command_manual",
 "manual_group": "material",
 "command": "IMKPinching",
 "doc_section": "user/manual/material/uniaxialMaterials",
 "rel_path": "user/manual/material/uniaxialMaterials/IMKPinching.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 4347,
 "word_count": 656,
...
Fig. 3.1.5.13 IMKPinching backbone curve

Fig. 3.1.5.14 IMKPinching sample responses and validations
