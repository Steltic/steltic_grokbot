<!-- chunk_id: triangleTimeSeries_p0 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/model/triangleTimeSeries.html",
 "title": "3.1.6.4. Triangular TimeSeries",
 "category": "command_manual",
 "manual_group": "model",
 "command": "triangleTimeSeries",
 "doc_section": "user/manual/model",
 "rel_path": "user/manual/model/triangleTimeSeries.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 1134,
 "word_count": 197,
...
Fig. 3.1.6.4 Triangle Time Series
