<!-- chunk_id: NormUnbalance_p0_2 | collection: opensees_documentation -->
<!-- meta: {
 "source": "opensees_documentation.md",
 "source_url": "https://OpenSees.github.io/OpenSeesDocumentation/user/manual/analysis/NormUnbalance.html",
 "title": "3.2.4.1. Norm Unbalance",
 "category": "command_manual",
 "manual_group": "analysis",
 "command": "NormUnbalance",
 "doc_section": "user/manual/analysis",
 "rel_path": "user/manual/analysis/NormUnbalance.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 1897,
 "word_count": 324,
