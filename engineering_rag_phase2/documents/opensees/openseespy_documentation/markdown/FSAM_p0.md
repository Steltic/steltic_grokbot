<!-- chunk_id: FSAM_p0 | collection: openseespy_documentation -->
<!-- meta: {
 "source": "openseespy",
 "source_file": "openseespy_documentation.md",
 "source_url": "https://openseespydoc.readthedocs.io/en/latest/src/FSAM.html",
 "title": "4.15.1.10. FSAM",
 "category": "general",
 "command": "FSAM",
 "doc_section": "src",
 "rel_path": "src/FSAM.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 3761,
 "word_count": 443,
...
| --- | --- |
| `rho` ([float](https://docs.python.org/3/library/functions.html#float)) | Material density |
| `sXTag` ([int](https://docs.python.org/3/library/functions.html#int)) | Tag of uniaxialMaterial simulating horizontal (x) reinforcement |
| `sYTag` ([int](https://docs.python.org/3/library/functions.html#int)) | Tag of uniaxialMaterial simulating vertical (y) reinforcement |
| `concTag` ([int](https://docs.python.org/3/library/functions.html#int)) | Tag of uniaxialMaterial simulating concrete, shall be used with uniaxialMaterial ConcreteCM |
| `rouX` ([float](https://docs.python.org/3/library/functions.html#float)) | Reinforcing ratio in horizontal (x) direction (\(rouX = _{s,x}/A_{gross,x}\)) |
| `rouY` ([float](https://docs.python.org/3/library/functions.html#float)) | Reinforcing ratio in vertical (x) direction (\(rouY = _{s,y}/A_{gross,y}\)) |
| `nu` ([float](https://docs.python.org/3/library/functions.html#float)) | Concrete friction coefficient (\(0.0 < \nu < 1.5\)) |
| `alfadow` ([float](https://docs.python.org/3/library/functions.html#float)) | Stiffness coefficient of reinforcement dowel action (\(0.0 < alfadow < 0.05\)) |

See also [here](http://opensees.berkeley.edu/wiki/index.php/FSAM_-_2D_RC_Panel_Constitutive_Behavior)
