<!-- chunk_id: elastomericBearingBoucWen_p0 | collection: openseespy_documentation -->
<!-- meta: {
 "source": "openseespy",
 "source_file": "openseespy_documentation.md",
 "source_url": "https://openseespydoc.readthedocs.io/en/latest/src/elastomericBearingBoucWen.html",
 "title": "4.2.6.2. Elastomeric Bearing (Bouc-Wen) Element",
 "category": "element",
 "command": "elastomericBearingBoucWen",
 "doc_section": "src",
 "rel_path": "src/elastomericBearingBoucWen.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 4433,
 "word_count": 451,
...
| `eta` ([float](https://docs.python.org/3/library/functions.html#float)) | yielding exponent (sharpness of hysteresis loop corners) (default = 1.0) |
| `beta` ([float](https://docs.python.org/3/library/functions.html#float)) | first hysteretic shape parameter (default = 0.5) |
| `gamma` ([float](https://docs.python.org/3/library/functions.html#float)) | second hysteretic shape parameter (default = 0.5) |
...
| `orientVals` ([list](https://docs.python.org/3/library/stdtypes.html#list) ([int](https://docs.python.org/3/library/functions.html#int))) | vector components in global coordinates defining local x-axis (optional), vector components in global coordinates defining local y-axis (optional) |
| `shearDist` ([float](https://docs.python.org/3/library/functions.html#float)) | shear distance from iNode as a fraction of the element length (optional, default = 0.5) |
...
| `mass` ([float](https://docs.python.org/3/library/functions.html#float)) | element mass (optional, default = 0.0) |

See also

[Notes](http://opensees.berkeley.edu/wiki/index.php/Elastomeric_Bearing_(Bouc-Wen)_Element)
