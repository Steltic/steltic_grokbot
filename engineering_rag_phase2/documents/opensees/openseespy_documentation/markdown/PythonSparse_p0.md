<!-- chunk_id: PythonSparse_p0 | collection: openseespy_documentation -->
<!-- meta: {
 "source": "openseespy",
 "source_file": "openseespy_documentation.md",
 "source_url": "https://openseespydoc.readthedocs.io/en/latest/src/PythonSparse.html",
 "title": "5.3.10. PythonSparse system",
 "category": "analysis",
 "command": "PythonSparse",
 "doc_section": "src",
 "rel_path": "src/PythonSparse.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 7348,
 "word_count": 842,
...
| `'writable'` | Buffers the solver may modify: `'values'`, `'rhs'`, `'values,rhs'` or `'all'`, or `'none'`. Also accepts a list: `['values', 'rhs']`. Default: `'none'` — only the solution buffer `x` is writable. |
...
The solver object must implement a `solve(**kwargs)` method. OpenSees passes matrix data as keyword arguments: memoryviews for arrays and scalars for metadata. Use [numpy.frombuffer](https://numpy.org/doc/stable/reference/generated/numpy.frombuffer.html) to interpret memoryviews as NumPy arrays without copying. The keyword structure depends on `scheme`:
...
This example uses [CuPy](https://cupy.dev/) and [cupyx.scipy.sparse.linalg.cg](https://docs.cupy.dev/en/stable/reference/generated/cupyx.scipy.sparse.linalg.cg.html) to solve the linear system on an NVIDIA GPU:
...
This example uses [SciPy](https://scipy.org/) [factorized](https://docs.scipy.org/doc/scipy/reference/generated/scipy.sparse.linalg.factorized.html) (sparse LU) on CPU:
...
Code developed by: [gaaraujo](https://github.com/gaaraujo)

See also

- [PythonSparse eigen solver](https://openseespydoc.readthedocs.io/en/latest/src/eigen.html#eigenpythonsparse) — PythonSparse interface for generalized eigenvalue problems (`eigen('PythonSparse', ...)`)
- [EXAMPLES/SolverBenchmark/benchmark_python_sparse.py](https://github.com/OpenSees/OpenSees/blob/master/EXAMPLES/SolverBenchmark/benchmark_python_sparse.py) — benchmark PythonSparse against native solvers
