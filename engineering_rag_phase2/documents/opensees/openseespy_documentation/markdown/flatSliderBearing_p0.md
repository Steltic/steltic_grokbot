<!-- chunk_id: flatSliderBearing_p0 | collection: openseespy_documentation -->
<!-- meta: {
 "source": "openseespy",
 "source_file": "openseespy_documentation.md",
 "source_url": "https://openseespydoc.readthedocs.io/en/latest/src/flatSliderBearing.html",
 "title": "4.2.6.3. Flat Slider Bearing Element",
 "category": "element",
 "command": "flatSliderBearing",
 "doc_section": "src",
 "rel_path": "src/flatSliderBearing.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 4370,
 "word_count": 483,
...
| `iter` ([int](https://docs.python.org/3/library/functions.html#int)) | maximum number of iterations to undertake to satisfy element equilibrium (optional, default = 20) |
...
[Notes](http://opensees.berkeley.edu/wiki/index.php/Flat_Slider_Bearing_Element)
