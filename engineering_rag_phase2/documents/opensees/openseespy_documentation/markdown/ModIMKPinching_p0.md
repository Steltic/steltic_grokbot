<!-- chunk_id: ModIMKPinching_p0 | collection: openseespy_documentation -->
<!-- meta: {
 "source": "openseespy",
 "source_file": "openseespy_documentation.md",
 "source_url": "https://openseespydoc.readthedocs.io/en/latest/src/ModIMKPinching.html",
 "title": "4.14.5.8. Modified Ibarra-Medina-Krawinkler Deterioration Model with Pinched Hysteretic Response (ModIMKPinching Material)",
 "category": "material",
 "command": "ModIMKPinching",
 "doc_section": "src",
 "rel_path": "src/ModIMKPinching.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 5849,
 "word_count": 598,
...
## 4.14.5.8. Modified Ibarra-Medina-Krawinkler Deterioration Model with Pinched Hysteretic Response (ModIMKPinching Material)
...
| `My_Neg` ([float](https://docs.python.org/3/library/functions.html#float)) | effective yield strength for negative loading direction (Must be defined as a negative value) |
| `FprPos` ([float](https://docs.python.org/3/library/functions.html#float)) | Ratio of the force at which reloading begins to force corresponding to the maximum historic deformation demand (positive loading direction) |
| `FprNeg` ([float](https://docs.python.org/3/library/functions.html#float)) | Ratio of the force at which reloading begins to force corresponding to the absolute maximum historic deformation demand (negative loading direction) |
| `A_pinch` ([float](https://docs.python.org/3/library/functions.html#float)) | Ratio of reloading stiffness |
...
[Notes](http://opensees.berkeley.edu/wiki/index.php/Modified_Ibarra-Medina-Krawinkler_Deterioration_Model_with_Pinched_Hysteretic_Response_(ModIMKPinching_Material))
