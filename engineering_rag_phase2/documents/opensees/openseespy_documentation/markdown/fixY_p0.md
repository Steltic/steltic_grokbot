<!-- chunk_id: fixY_p0 | collection: openseespy_documentation -->
<!-- meta: {
 "source": "openseespy",
 "source_file": "openseespy_documentation.md",
 "source_url": "https://openseespydoc.readthedocs.io/en/latest/src/fixY.html",
 "title": "4.4.3. fixY command",
 "category": "general",
 "command": "fixY",
 "doc_section": "src",
 "rel_path": "src/fixY.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 562,
 "word_count": 55,
...
| `y` ([float](https://docs.python.org/3/library/functions.html#float)) | y-coordinate of nodes to be constrained |
| --- | --- |
