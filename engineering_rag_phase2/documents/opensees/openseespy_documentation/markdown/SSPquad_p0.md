<!-- chunk_id: SSPquad_p0 | collection: openseespy_documentation -->
<!-- meta: {
 "source": "openseespy",
 "source_file": "openseespy_documentation.md",
 "source_url": "https://openseespydoc.readthedocs.io/en/latest/src/SSPquad.html",
 "title": "4.2.7.10. SSPquad Element",
 "category": "element",
 "command": "SSPquad",
 "doc_section": "src",
 "rel_path": "src/SSPquad.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 2553,
 "word_count": 318,
...
| `type` ([str](https://docs.python.org/3/library/stdtypes.html#str)) | string to relay material behavior to the element, can be either `'PlaneStrain'` or `'PlaneStress'` |
...
| `b1` `b2` ([float](https://docs.python.org/3/library/functions.html#float)) | constant body forces in global x- and y-directions, respectively (optional, default = 0.0) |
...
[Notes](http://opensees.berkeley.edu/wiki/index.php/SSPquad_Element)
