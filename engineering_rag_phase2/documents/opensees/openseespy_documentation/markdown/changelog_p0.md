<!-- chunk_id: changelog_p0 | collection: openseespy_documentation -->
<!-- meta: {
 "source": "openseespy",
 "source_file": "openseespy_documentation.md",
 "source_url": "https://openseespydoc.readthedocs.io/en/latest/src/changelog.html",
 "title": "3. Change Log",
 "category": "general",
 "command": "changelog",
 "doc_section": "src",
 "rel_path": "src/changelog.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 11104,
 "word_count": 1360,
...
- **Version `3.4.0.5<https://github.com/zhuminjie/OpenSeesPy/tree/v3.4.0.5>`_** (11/29/2022)
  ...
  - Add [damping](https://github.com/OpenSees/OpenSees/pull/359)
...
- **Version 3.4.0.2** (7/20/2022)
  ...
  - Update to commit [abebbee](https://github.com/OpenSees/OpenSees/tree/abebbeeb5006d9f1c623e713972787eb7db49746).
...
- **Version 3.4.0.1** (12/22/2021)
  ...
  - Update to OpenSees version [3.4.0](https://github.com/OpenSees/OpenSees/releases/tag/v3.4.0) at commit [3b28d0c](https://github.com/OpenSees/OpenSees/commit/3b28d0c8d34e5632e62d313585df8e8656277a5a).
...
- **Version 3.3.0.0** (6/4/2021)
  ...
  - Update to [3.3.0.0](https://github.com/OpenSees/OpenSees/releases/tag/v3.3.0) at commit [5c925e6](https://github.com/OpenSees/OpenSees/commit/5c925e6a24bf3fbda58e57dde32cde658b3c5d5b).
...
- **Version 3.1.5.11** (1.10.2020)
  ...
  - Change versioning method. First two digits match the current [OpenSees](https://github.com/OpenSees/OpenSees) framework version. The last two digits are the versions for OpenSeesPy.
  - For Windows, only support the Python version that corresponds to the current version of [Anaconda](https://www.anaconda.com/distribution/#download-section).
...
- **Version 0.2.0** ([8a3d622](https://github.com/OpenSees/OpenSees/tree/8a3d6225a14ef52c7711248e1a9e65fe298454c6))
...
- **Version 0.1.1** ([f9f45fe](https://github.com/OpenSees/OpenSees/tree/f9f45fe7cf0094cd99fd92c2f794187b42cf9289))

  - Update to OpenSees 3.0.2
- **Version 0.0.7** ([b75db21](https://github.com/zhuminjie/OpenSees/tree/b75db21028c2dbbca55ea86d081893ff9b0f0be3))
...
- **Version 0.0.6** ([cead6e8](https://github.com/OpenSees/OpenSees/tree/cead6e858e20b02345a28de379f962b41d0796e9))
...
- **Version 0.0.5** ([215c63d](https://github.com/OpenSees/OpenSees/tree/215c63dec501438a166a9be67db0ff1427d316ba))
