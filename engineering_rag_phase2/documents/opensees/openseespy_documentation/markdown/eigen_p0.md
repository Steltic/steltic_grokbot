<!-- chunk_id: eigen_p0 | collection: openseespy_documentation -->
<!-- meta: {
 "source": "openseespy",
 "source_file": "openseespy_documentation.md",
 "source_url": "https://openseespydoc.readthedocs.io/en/latest/src/eigen.html",
 "title": "5.8. eigen command",
 "category": "general",
 "command": "eigen",
 "doc_section": "src",
 "rel_path": "src/eigen.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 6309,
 "word_count": 698,
...
| numEigenvalues ([int](https://docs.python.org/3/library/functions.html#int)) | number of eigenvalues required |
| --- | --- |
| solver ([str](https://docs.python.org/3/library/stdtypes.html#str)) | optional string detailing type of solver: `'-genBandArpack'`, `'-fullGenLapack'`, `'-symmBandLapack'`, or `'PythonSparse'` (optional) |
...
- [PythonSparse system](https://openseespydoc.readthedocs.io/en/latest/src/PythonSparse.html#systempythonsparse) — PythonSparse linear system (`system('PythonSparse', ...)`)
- [EXAMPLES/SolverBenchmark/benchmark_python_sparse_eigen.py](https://github.com/OpenSees/OpenSees/blob/master/EXAMPLES/SolverBenchmark/benchmark_python_sparse_eigen.py)
