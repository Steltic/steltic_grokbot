<!-- chunk_id: zeroLengthND_p0 | collection: openseespy_documentation -->
<!-- meta: {
 "source": "openseespy",
 "source_file": "openseespy_documentation.md",
 "source_url": "https://openseespydoc.readthedocs.io/en/latest/src/zeroLengthND.html",
 "title": "4.2.1.2. zeroLengthND Element",
 "category": "element",
 "command": "zeroLengthND",
 "doc_section": "src",
 "rel_path": "src/zeroLengthND.html",
 "part_index": 0,
 "part_count": 1,
 "char_count": 2419,
 "word_count": 294,
...
| `matTag` ([int](https://docs.python.org/3/library/functions.html#int)) | tag associated with previously-defined ndMaterial object |
| `uniTag` ([int](https://docs.python.org/3/library/functions.html#int)) | tag associated with previously-defined UniaxialMaterial object which may be used to represent uncoupled behavior orthogonal to the plane of the NDmaterial response. SEE NOTES 2 and 3. |
...
[Notes](http://opensees.berkeley.edu/wiki/index.php/ZeroLengthND_Element)
